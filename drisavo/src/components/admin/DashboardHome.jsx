...
import { User, MessageSquare, Settings, TrendingUp, Calendar } from 'lucide-react';
...
const DashboardHome = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      // Map raw quickStatsData into shape with icon & color
      const mappedQuickStats = (quickStatsData || []).map((item) => {
        switch (item.metric) {
          case 'totalInquiries':
            return {
            ...
            <div className="card-content">
              <div className="overview-grid">
                <div className="overview-item">
                  <p className="overview-value">{stats.overview.new_inquiries}</p>
                  <p className="overview-label">{t('dashboardh.newInquiries')}</p>
                </div>
                <div className="overview-item">
                  <p className="overview-value">{stats.overview.in_progress_inquiries}</p>
                  <p className="overview-label">{t('dashboardh.inProgress')}</p>
                </div>
                <div className="overview-item">
                  <p className="overview-value">{stats.overview.completed_inquiries}</p>
                  <p className="overview-label">{t('dashboardh.completed')}</p>
                </div>
                <div className="overview-item">
                  <p className="overview-value">{stats.overview.today_inquiries}</p>
